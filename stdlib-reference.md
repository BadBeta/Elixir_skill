# Elixir Standard Library & Data Structures Reference

> Supporting reference for the [Elixir skill](SKILL.md). Contains detailed data structure patterns, quick references for all major modules, Erlang standard library integration, and JSON encoding.
